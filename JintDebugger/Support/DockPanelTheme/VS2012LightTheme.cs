...
namespace JintDebugger.Support.DockPanelTheme
{
    ...
    public class VS2012LightTheme : ThemeBase
    {
        ...
        public override void Apply(DockPanel dockPanel)
        {
            ...
            dockPanel.Extender.DockPaneStripFactory = new VS2012LightDockPaneStripFactory(ShowWindowList);
        ...
        private class VS2012LightDockPaneStripFactory : DockPanelExtender.IDockPaneStripFactory
        {
            ...
            public VS2012LightDockPaneStripFactory(bool showWindowList)
            {
            ...
            {
                return new VS2012LightDockPaneStrip(pane, _showWindowList);
            }
        }
