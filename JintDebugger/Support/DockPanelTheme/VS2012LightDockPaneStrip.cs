...
namespace JintDebugger.Support.DockPanelTheme
{
    internal class VS2012LightDockPaneStrip : DockPaneStripBase
    {
        ...
        private InertButton ButtonWindowList
        {
            get
            {
                if (m_buttonWindowList == null)
                {
                    ...
                    m_buttonWindowList.Visible = _showWindowList;
        ...
        public VS2012LightDockPaneStrip(DockPane pane, bool showWindowList)
            : base(pane)
        {
            ...
            _showWindowList = showWindowList;
        ...
        private const int TAB_CLOSE_BUTTON_WIDTH = 15;
        ...
        private void DrawTab_Document(Graphics g, TabVS2012Light tab, Rectangle rect)
        {
            ...
            var rectCloseButton = GetCloseButtonRect(rect, tab.Content.DockHandler.CloseButtonVisible);
            Rectangle rectIcon = new Rectangle(
        ...
        private Rectangle GetCloseButtonRect(Rectangle rectTab, bool visible)
        {
            if (Appearance != WeifenLuo.WinFormsUI.Docking.DockPane.AppearanceStyle.Document || !visible)
            {
        ...
        protected override void OnMouseHover(EventArgs e)
        {
            ...
            if (index != -1)
            {
                ...
                var closeButtonRect = GetCloseButtonRect(tabRect, tab.Content.DockHandler.CloseButtonVisible);
